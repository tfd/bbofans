(function ($) {
  ...
  $.extend($.fn.bootstrapTable.defaults, {
      ...
      columnGroups: {
        info: ['select', 'bboName', 'registeredAt', 'name', 'nation', 'email', 'level', 'isEnabled'],
        flags: ['select', 'bboName', 'email', 'isEnabled', 'isStarPlayer', 'isRbdPlayer', 'isBlackListed', 'isBanned'],
        rock: ['select', 'bboName', 'rockNumTournaments', 'rockLastPlayedAt', 'rockAverageScore', 'rockAverageMatchPoints', 'rockAwards'],
        rbd: ['select', 'bboName', 'isRbdPlayer', 'rbdNumTournaments', 'rbdLastPlayedAt', 'rbdAverageScore', 'rbdAverageMatchPoints', 'rbdAwards']
      }
  });
